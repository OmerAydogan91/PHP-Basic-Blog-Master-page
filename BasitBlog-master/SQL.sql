...
(1,	'ömer',	'123',	'ömer aydoğan'),
(2,	'salih',	'123',	'salih Yılmaz');
...
(1,	'Ömer aydoğan',	'2017-08-21',	'PHP Dersleri',	'TBD ders yazısı burada olacak'),
(4,	'Nuri kankam',	'2017-08-21',	'MySQL Öğrendik',	'Yazı burada olacak'),
...
(13,	'salih aydoğan\"nn\'n',	'2017-08-12',	'Test123',	'test yazısı'),
